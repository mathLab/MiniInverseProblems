...
class EigenStream
{
	...
	//--------------------------------------------------------------------------
        /// Export a vector in numpy, matlab or txt format
        ///
        /// @param[in] vector    Eigen::VectorXd that you want to export.
        /// @param[in] Name      Name of saved file.
        /// @param[in] tipo      Format of the file: numpy (tipo="python"), matlab (tipo="matlab"), txt (tipo="eigen").
        /// @param[in] folder    Directory in which the fali is saved.
        ///
        static void exportVector(Eigen::VectorXd& vector, std::string Name,
                                 std::string tipo = "python", std::string folder = "./Matrices")
	{
	    Eigen::MatrixXd matrix = vector;
            exportMatrix(matrix, Name, tipo, folder);
